...
Pricing is versioned. Promotions can target all, one, or any subset of 1/3/6/12-month products with different discounts by duration.
...
## Loyalty and membership interaction
